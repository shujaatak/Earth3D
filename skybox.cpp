...
SkyBox::SkyBox(QOpenGLShaderProgram *prog)
{
    ...
    faces.push_back("../earth10-master/miramar_rt.tga");
    faces.push_back("../earth10-master/miramar_lf.tga");
    faces.push_back("../earth10-master/miramar_up1.tga");
    faces.push_back("../earth10-master/miramar_dn.tga");
    faces.push_back("../earth10-master/miramar_bk.tga");
    faces.push_back("../earth10-master/miramar_ft.tga");
